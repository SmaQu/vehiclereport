...
@Database(entities = {Category.class, Reports.class}, version = 1)
public abstract class VehicleReportDatabase extends RoomDatabase {
    ...
    public synchronized static VehicleReportDatabase getInstance(final Context context) {
        if (INSTANCE == null) {
    ...
    private static VehicleReportDatabase buildVehicleReportDatabase(final Context context) {
        return Room.databaseBuilder(context.getApplicationContext(),
                ...
                "file_database_vehicle_report_database.db")
